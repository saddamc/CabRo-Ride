// // Cabro-bolt static top navbar design (no logic)
...
//                 <Sun className="w-5 h-5 text-yellow-500 absolute" />
//                 <Moon className="w-5 h-5 text-gray-300 absolute opacity-0 dark:opacity-100" />
//               </div>
//             </button>
