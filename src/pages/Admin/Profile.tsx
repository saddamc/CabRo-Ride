        ...
        <div className="md:col-span-2">
          <Tabs defaultValue="account">
            <TabsList className="grid grid-cols-2 mb-4">
              <TabsTrigger className="bg-cyan-300" value="account">Account</TabsTrigger>
              <TabsTrigger className="bg-orange-300" value="security">Security</TabsTrigger>
            </TabsList>

            <TabsContent value="account">
              <Card className="border-0 shadow-sm bg-cyan-100">
            ...
            <TabsContent value="security">
              <Card className="border-0 shadow-sm bg-orange-100 ">
                <CardHeader>
